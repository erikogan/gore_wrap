...
# producing a "shape" a few nanometres across -- a stab mark in the cut file,
...
def _boundary_runs(cpts, x_lo, x_hi, y_hi, closed, tol=1e-6):
    ...
    *nominally* on a tile boundary (e.g. an edge at 39.9999 in a 40-unit
    ...
    behaviour instead of being detected and dropped. Do not change this
    ...
    pre-existing behaviour. Otherwise every returned run has
