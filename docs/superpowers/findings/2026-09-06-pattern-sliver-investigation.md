...
|---|---|---|---|---|---|
| gap to neighbour | 0.60 | 0.72 | 1.05 | **1.76** | 2.98 mm |

75.3% of the pattern has neighbour gaps under 3 mm; 22.8% under 1 mm.
...
neighbouring path — the owner sees an orphan; the scorer sees two perfectly
...
1. **Colour will not distinguish polarity in this file.** All 234 shapes carry
   ...
   explicit user control, with colour at best a hint.
